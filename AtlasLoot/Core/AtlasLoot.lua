...
ATLASLOOT_VERSION = "|cffFFFFFF"..AtlasLootVersionsList[#AtlasLootVersionsList] .." AtlasLoot Nozdor by Альтруист|r";
...
function AtlasLoot_GetLODModule(dataSource)
	...
	elseif (dataSource=="Atlasloot_Nozdor") then
		return "Nozdor";
	end
end
...
function AtlasLoot_LoadAllModules()
	local orig, bc, wotlk, craft, world, pvp, nozdor;
	...
	nozdor, _ = LoadAddOn("Atlasloot_Nozdor");
    local flag=0;
	if not orig then
